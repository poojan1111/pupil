                ...
                <form @submit.prevent="searchFormProps.onSearch">
                    ...
                    <div class="vehica-search-classic-v2__fields--wrapper">
                        <div class="vehica-search-classic-v2__fields">
                            ...
                            for ($i = 0; $i <= 2; $i++) : 
                                 $vehicaSearchField = $vehicaSearchFields[$i]; 
                            ...
                            <div class="vehica-search-classic-v2__search-button-wrapper advance-btn">
                                <span class="advance-search" id="advance_search">Advance Search</span>  </div>
                        </div>
                    </div>
                    <div class="vehica-search-classic-v2__fields advance-filds" style="display:none">  
                        <?php
                        global $vehicaSearchField;
                        for ($i = 0; $i < 8; $i++) :
                             $vehicaSearchField = $vehicaSearchFields[$i]; 
                             if ($i < 3){continue;}  // Skip the execution of the loop after the third iteration 
                             if ($vehicaSearchField->isTaxonomy()) : 
                                 get_template_part('templates/general/search/fields/taxonomy'); 
                             elseif ($vehicaSearchField->isNumberField()) : 
                                 get_template_part('templates/general/search/fields/number'); 
                        ...
                        <div class="vehica-search-classic-v2__search-button-wrapper advance-less">
